...
const ROLES = [
    ...
    { value: 'Instructor', label: 'Instructor', desc: 'Teach and guide aspiring entrepreneurs' },
            ...
            >
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <p className="text-emerald-100 text-base leading-relaxed max-w-xs">
                        Create your account and become part of a growing network of change-makers across the region.
                    </p>
                    ...
                    <div className="space-y-2">
                        {ROLES.map(({ value, label }) => (
                            <div
                                ...
                                style={{
                                    background: role === value ? 'rgba(255,255,255,0.18)' : 'rgba(255,255,255,0.07)',
                                    borderLeft: role === value ? '3px solid #fff' : '3px solid transparent',
                                }}
                            >
                ...
                <p className="relative z-10 text-emerald-300 text-sm">
                    © {new Date().getFullYear()} Wezesha Initiative
                </p>
            </div>
                                ...
                                {ROLES.map(({ value, label, desc }) => (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            boxShadow: role === value ? '0 0 0 2px #1a7a5e22' : 'none',
                                        }}
                                    >
                                        <span
